...
export default function BillingReportPage() {
  ...
  useEffect(() => {
    const loadBills = async () => {
      ...
      try {
        const rows = await superAdminService.getBills({
          subCityId: isSubcityBillingOfficer ? payload?.subCityId || "" : "",
          woredaId: isSubcityBillingOfficer ? "" : payload?.woredaId || "",
        });
    ...
    void loadBills();
  }, [isSubcityBillingOfficer, payload?.subCityId, payload?.woredaId]);
