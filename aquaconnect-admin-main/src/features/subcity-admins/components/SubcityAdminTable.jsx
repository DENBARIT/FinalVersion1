...
export default function SubcityAdminTable({
  admins,
  onEdit,
  onDelete,
  onStatusChange,
}) {
  if (!admins.length) return <EmptyState message="No subcity admins found." />;
              ...
              <td className="py-3">
                <div className="flex items-center gap-2">
                  {admin.status === "SUSPENDED" ? (
                    <button
                      onClick={() => onStatusChange(admin, "ACTIVE")}
                    ...
                    <button
                      onClick={() => onStatusChange(admin, "SUSPENDED")}
